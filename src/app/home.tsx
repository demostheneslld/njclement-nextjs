...
import { bio, careerItems, socialLinks, technicalProficiencies } from '@/config/constants';
    ...
    <>
      <div className='flex flex-col items-center gap-y-6'>
        <div className='max-w-3xl w-full rounded flex flex-col gap-y-8'>
          <img alt='Profile Image' className='max-w-xs w-full rounded-full m-auto filter grayscale hover:filter-none transition-all duration-500' src='/profile.jpg' />
