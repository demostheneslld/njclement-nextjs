  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col md:flex-row gap-8 items-start'>
        { editMode === 'on' && 
          <div className='w-full md:w-1/2 rounded-lg p-4 border border-gray-800 bg-[color:var(--c-bg-night)] shadow-sm'>
            <h3 className="text-lg font-semibold mb-2" style={{color:'var(--c-text-high)'}}>Resume Source JSON</h3>
            <textarea
              className="w-full h-[700px] p-2 border border-gray-700 rounded-md font-mono text-xs bg-[color:var(--c-bg-fog)] text-[color:var(--c-text-high)] focus:ring-primary-500 focus:border-primary-500 transition"
        ...
        <div className={`w-full ${editMode === 'on' ? 'md:w-1/2' : 'max-w-4xl mx-auto'}`}>
          <div className="rounded-lg overflow-hidden border border-gray-700 bg-[color:var(--c-bg-fog)] shadow-lg">
